                ...
                <Carousel controls={false} indicators={false}>
                    <Carousel.Item>
                        ...
                        <Carousel.Caption style={{paddingBottom: '50px'}}>
                            <Button size="lg" variant="light" style={{margin: '50px', fontSize: '14px', width: '180px'}} className="mb-0" >SHOP MEN</Button>
                            <Button size="lg" variant="light" style={{margin: '50px', fontSize: '14px', width: '180px'}} className="mb-0">SHOP WOMEN</Button>
                        </Carousel.Caption>
                    </Carousel.Item>
                </Carousel>
            </div>
